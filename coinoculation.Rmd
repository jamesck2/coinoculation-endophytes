...
(p1 <- ggplot(tp_ep %>% 
  ...
  scale_x_discrete(breaks = c("141","522co141",
                                 "702co141","717co141","733co141"),
                   labels = c(expression(atop(italic("Sinorhizobium "), only)),
                              expression(atop(Co-inoculation, with~italic("Pa. ")~522)),
                              expression(atop(Co-inoculation, with~italic("Ps. ")~"702A")),
                              expression(atop(Co-inoculation, with~italic("Pa. ")~"717A")),
                              expression(atop(Co-inoculation, with~italic("Ps. ")~"733A"))
                              )
                   ) +
...
## save plot
save_plot("./treated/Fig1.png", fig,
          ncol = 1, 
          nrow = 2,
...
(p <- ggplot(Nadd.r %>% 
  ...
  scale_x_discrete(breaks = c("717A","733B"),
                   labels = c(expression(italic("Ps. ")~"717A"),
